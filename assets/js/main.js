 ...
 * Gate, nav, countdown, particles, map embed, animations
 * Sections: Hero → Invitation → Date → Location → Gallery
 */
...
function setupMapEmbed() {
  ...
  iframe.src = `https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=${query}&zoom=15&language=ar`;
  
  // Fallback: if embed key fails, use search embed
  iframe.onerror = function() {
    this.src = `https://maps.google.com/maps?q=${query}&t=&z=15&ie=UTF8&iwloc=&output=embed`;
  };

  // Try the free embed method
